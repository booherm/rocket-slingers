#include "PoPendulumBox2d.hpp"

PoPendulumBox2d::PoPendulumBox2d(const std::string& objectId, GameState* gameState) : PhysicalObject(objectId, gameState) {
...
void PoPendulumBox2d::initShaders() {
...
void PoPendulumBox2d::initGeometry() {
...
void PoPendulumBox2d::initPhysics() {
...
void PoPendulumBox2d::doPhysicalUpdate() {
...
PoPendulumBox2d::~PoPendulumBox2d() {
