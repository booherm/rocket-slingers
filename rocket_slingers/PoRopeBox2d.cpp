#include "PoRopeBox2d.hpp"

PoRopeBox2d::PoRopeBox2d(const std::string& objectId, GameState* gameState) : PhysicalObject(objectId, gameState) {
...
void PoRopeBox2d::gameEventCallback(const Event& eventObj) {

	attachedToStructure = false;
	player = (PoGuyBox2d*) eventObj.eventPoster;
...
void PoRopeBox2d::doPhysicalUpdate() {
...
PoRopeBox2d::~PoRopeBox2d() {
	destructRope();
}

void PoRopeBox2d::destructRope() {
